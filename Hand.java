import java.util.*;  //for ArrayList<T>
...
public class Hand 
{
    ...
    // This represents the list of cards in the hand - known as a hand of cards.
    ...
    {
        return getValue() == 21 && aHand.size() == 2;
    }
    ...
    {
        return aHand.size() == 5 && getValue() <= 21;
    }
