/* Card.java will create a single playing card
 *
 */
public class Card
{
    ...
    // cards(cards above 10). To maintain the ordering after
    ...
    // This represents the rank of the card, integer value from 2 to Ace.
    private int rank;
    
    // This represents the suit of the card, zero is hearts, 1 diamonds, 2 spades or 3 clubs.
    private int suit;
    
    // This represents the numeric value (points) of the card(for Blackjack), which is 10 for face cards or 11 for an ace.
    private int value;
     ...
     * we pass in its rank and its suit. Use the constants when possible.
     * 
